import type { BattlePhase, BattleSnapshot, BattleState } from '../models/BattleSnapshot.js'
...
export class BattleManager {
    ...
    getBaseRivalGain(phase: BattlePhase): number {
        if (phase === 'opening') {
    ...
    getCatchUpAdjustment(playerScore: number): number {
    ...
    getTempoAdjustment(scoreSnapshot: ScoreSnapshot): number {
        let adjustment = 0
    ...
    getOscillation(timeLeft: number): number {
