...
export class GameConfig {
    ...
    static ROBOT_STEP_MS = 2000
    static ROBOT_STEP_ACCELERATION_MS = 10
    static MIN_ROBOT_STEP_MS = 1350
    static BOOST_ROBOT_STEP_REDUCTION_MS = 160
    static MIN_BOOST_ROBOT_STEP_MS = 980
