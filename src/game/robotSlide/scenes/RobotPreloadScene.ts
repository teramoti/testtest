...
export class Start extends Phaser.Scene {
    ...
    preload(): void {
        ...
        this.load.image('tile-corner-top-right', 'assets/Image/path_tiles_32x32/path_corner_top_right.png')
        this.load.image('tile-corner-right-bottom', 'assets/Image/path_tiles_32x32/path_corner_left_top.png')
        this.load.image('tile-corner-bottom-left', 'assets/Image/path_tiles_32x32/path_corner_left_bottom.png')
        this.load.image('tile-corner-left-top', 'assets/Image/path_tiles_32x32/path_corner_left_top.png')
